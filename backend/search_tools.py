...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            source = {
                "text": source_text,
                "url": lesson_link  # Will be None if no link exists
            }
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get the complete outline of a course including course title, course link, and all lessons with their numbers and titles. Use this for questions about course structure, syllabus, or what topics are covered.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
                        "type": "string",
                        "description": "Course title or partial name to search for (e.g. 'MCP', 'Computer Use', 'RAG')"
                    }
                },

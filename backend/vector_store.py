...
class VectorStore:
    ...
    def _resolve_course_name(self, course_name: str) -> Optional[str]:
        ...
        try:
            ...
            if results['documents'][0] and results['metadatas'][0]:
                # Check distance threshold - reject poor matches
                # ChromaDB returns squared L2 distance; lower is better
                # Threshold of 1.5 allows partial matches but rejects unrelated queries
    ...
    def get_course_outline(self, course_name: str) -> Optional[Dict[str, Any]]:
        ...
        Uses semantic search to find matching course.
